...
public class VentanaDivisas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botonC.setBackground(new java.awt.Color(0, 204, 153));
    ...
    private void CalculadoraEstandarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CalculadoraEstandarActionPerformed
        VentanaCalculadora calculadora = new VentanaCalculadora(); // Ahora si estamos en la ventana divisas, pasaremos a la ventana calculadora creando un objeto 
    ...
    private void comboDivisas1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboDivisas1ActionPerformed
        ...
        if (divisa1.equals("Estados Unidos - Dólar") ) {
            ...
            etiquetaDivisa1.setText("$/MX");
        }
        else if (divisa1.equals("Europa - Euro")) {
            etiquetaDivisa1.setText("€");
        }
        
        obtenerDinero(); //Cada que cambiemos de divisa obtenemos el dinero con el metodo que hicimos 
    ...
    private void obtenerDinero(){
        cantidad = etiquetaCambio1.getText(); //Obtenemos lo que hay en la etiqueta 
        dinero = Double.parseDouble(cantidad); //Este String "cantidad" lo pasamos a double en la variable dinero
        cambioDivisas();  //Llamamos al metodo 
        dinero *= cambio; //Multipl. el dinero con el valor de cada cambio dependiendo la moneda 
        etiquetaCambio2.setText(String.format("%.2f", dinero)); //Que solo imprima dos decimales de dinero 
        
    }
    
    private void cambioDivisas(){
        if(divisa1.equals(divisa2)){ //Si ambas divisas son iguales 
            cambio = 1;
        }
