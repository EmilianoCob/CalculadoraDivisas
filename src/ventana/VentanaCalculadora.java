...
public class VentanaCalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botonRaiz.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/raizCuadrada.png"))); // NOI18N
        ...
        botonIgual.setBackground(new java.awt.Color(0, 204, 153));
    ...
    private void ConversorDivisasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConversorDivisasActionPerformed
        VentanaDivisas conversor = new VentanaDivisas();  //Para pasar de una ventana a otra, en este caso creamos un objeto 
        conversor.setVisible(true);
        
        dispose();  //Se cierra la ventana original y se cierra la otra ventana, para no tener dos abiertas
    }//GEN-LAST:event_ConversorDivisasActionPerformed

    private void boton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton9ActionPerformed
        //El 9 lo puse primero desde antes, pero esta bien 
    ...
    private void boton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton1ActionPerformed
        if (etiquetaNumeros.getText() == "0") {
            ...
            cadenaNumeros += "1"; //Al presionar el boton del numero 1 se guarada el Sring "1" en nuestra variable cadenaNumeros
        }
        etiquetaNumeros.setText(cadenaNumeros); // Y este se mostrara en la etiquetaNumeros.
        activado = true;
    ...
    private void botonSumarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSumarActionPerformed
        if (activado == true) {
            numero1 = Double.parseDouble(cadenaNumeros); //cadenaNumeros es un String asi que lo transformamos a un double 
            etiquetaMuestra.setText(cadenaNumeros+" + ");
            cadenaNumeros = ""; //La regresamos a que no tenga nada 
            operacion = "sumar";
